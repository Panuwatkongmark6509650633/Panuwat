...
การกำหนด `.gitignore` ช่วยลดความเสี่ยงในการแชร์ข้อมูลที่ไม่จำเป็นหรือข้อมูลลับ เช่น คีย์ API รหัสผ่าน หรือไฟล์การตั้งค่าเฉพาะท้องถิ่น นอกจากนี้ยังช่วยให้ repository ของคุณมีขนาดเล็กลงและสะอาดขึ้น โดยการละเว้นไฟล์ที่ไม่จำเป็น
